...
@section('title', 'Edit Pengumuman - Mahasiswa')
...
<div class="row">
    <div class="col-12 col-md-12 col-lg-8">
        <div class="card">
            ...
            <form action="{{ route('pro.edPe_mahasiswa') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('ha_pe_mahasiswa') }}" class="btn btn-success">+ Tambah Pengumuman</a>
            ...
            <div class="card-body">
                ...
                <li class="media">
                    <div class="media-body">
                      <a href="{{ route('bc.pe_m',$p->id) }}"><h5 class="mt-0 mb-1 primary">{{ $p->judul }}</h5></a>
