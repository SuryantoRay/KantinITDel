          ...
          <div class="col-12 col-md-12 col-lg-5">
            ...
            <div class="card profile-widget">
                <div class="profile-widget-header">
                  ...
                  @else
                    <img alt="image" src="{{ asset('img/Mahasiswa/Profil/'.$us->gambar) }}" height="110" width="110" class="rounded-circle profile-widget-picture">
                  @endif
                ...
                <div class="profile-widget-description">
                  <div class="profile-widget-name">{{ $us->name }}<div class="text-muted d-inline font-weight-normal"><div class="slash"></div> Mahasiswa</div></div>
                    ...
                    <div class="tab-content" id="myTabContent2">
                      <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                        <div class="card-header">
                          ...
                          @foreach ($User as $us)
                            <form action="{{ route('ed.pro_mahasiswa') }}" method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                      ...
                      <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                        <form action="{{ route('ed.Gpro_mahasiswa') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <h4>Edit Gambar</h4>
                          </div>
