...
@section('title', 'Edit Pengumuman - Ketertiban')
...
<div class="row">
    <div class="col-12 col-md-12 col-lg-8">
        <div class="card">
            ...
            <form action="{{ route('pro.ed_pe_ktr') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('h.pe_ktr') }}" class="btn btn-success">+ Tambah Pengumuman</a>
    ...
    <div class="col-12 col-md-12 col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <li class="media">
                    <div class="media-body">
                      <a href="{{ route('bc.pe_ktr',$p->id) }}"><h5 class="mt-0 mb-1 primary">{{ $p->judul }}</h5></a>
                      <div class="text-left m-2">
                        <i class="fas fa-tags"> {{ $p->kepada }}</i> &nbsp
                        <i class="far fa-clock"> {{ $p->created_at }}</i>
                      </div>
                        <div class="text-right">
                            <a href="{{ route('ed.pe_ktr',$p->id) }}" type="submit">Edit</a> <div class="bullet"></div>
            ...
            <div class="card-footer text-right">
                <a href="{{ route('sm.pe_ktr') }}">Lihat Semua <i class="fas fa-arrow-alt-circle-right"></i></a>
            </div>
        </div>
    </div>
</div>
