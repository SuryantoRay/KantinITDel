...
@section('title', 'Pengumuman - Ketertiban')
...
<div class="row">
    <div class="col-12 col-md-12 col-lg-8">
        <div class="card">
            ...
            <form action="{{ route('tm.pe_ktr') }}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="card-body">
                ...
                <li class="media">
                    <div class="media-body">
                      <a href="{{ route('bc.pe_ktr',$p->id) }}"><h6 class="mt-0 mb-1 primary">{{ $p->judul }}</h6></a>
