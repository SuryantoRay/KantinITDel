...
@section('master_judul', 'Dashboard | Keasramaan')
...
<div class="row">
    <div class="col-12 col-md-12 col-lg-8">
        <div class="section-body">
            ...
            <p class="section-lead">Ini adalah informasi mengenai makana makanan yang ada di kantin kita.</p>
    ...
    <div class="col-12 col-md-12 col-lg-4">
        <div class="card">
            ...
            <div class="card-footer text-right">
                <a href="">Lihat Semua <i class="fas fa-arrow-alt-circle-right"></i></a>
            </div>
        </div>
    </div>
