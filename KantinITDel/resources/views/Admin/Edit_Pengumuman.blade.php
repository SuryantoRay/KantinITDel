...
<div class="row">
    <div class="col-12 col-md-12 col-lg-8">
        <div class="card">
            ...
            <form action="{{ route('ed.pro_pe_admin') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="kepada" class="form-control">
                        <option value="{{ $pe->kepada }}">{{ $pe->kepada }}</option>
                        @if ($pe->kepada === "Mahasiswa")
                            <option value="Semua">Semua</option>
                            <option value="Keasramaan">Keasramaan</option>
                            <option value="Ketertipan">Ketertipan</option>
                        @elseif ($pe->kepada === "Keasramaan")
                            <option value="Semua">Semua</option>
                            <option value="Mahasiswa">Mahasiswa</option>
                            <option value="Ketertipan">Ketertipan</option>
                        @elseif ($pe->kepada === "Ketertipan")
                            <option value="Semua">Semua</option>
                            <option value="Mahasiswa">Mahasiswa</option>
                            <option value="Keasramaan">Keasramaan</option>
                        @endif
                ...
                <div class="card-footer text-right">
                    <a href="{{ route('h.crud_pengumuman') }}" class="btn btn-success">+ Tambah Pengumuman</a>
    ...
    <div class="col-12 col-md-12 col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <li class="media">
                    <div class="media-body">
                      <a href="{{ route('bc_pe',$p->id) }}"><h5 class="mt-0 mb-1 primary">{{ $p->judul }}</h5></a>
                      <div class="text-left m-2">
                        <i class="fas fa-tags"> {{ $p->kepada }}</i> &nbsp
                        <i class="far fa-clock"> {{ $p->created_at }}</i>
                      </div>
                        <div class="text-right">
                            <a href="{{ route('ed.pe_admin',$p->id) }}" type="submit">Edit</a> <div class="bullet"></div>
            ...
            <div class="card-footer text-right">
                <a href="{{ route('sm.pe_admin') }}">Lihat Semua <i class="fas fa-arrow-alt-circle-right"></i></a>
            </div>
        </div>
    </div>
</div>
