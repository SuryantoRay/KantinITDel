                    ...
                    <form action="" method="post">
                        <table id="example" class="table align-items-center table-flush">
                           ...
                           <tbody>
                              ...
                              <tr>
                                  <td>{{ $no+1 }}</td>
                                  <td><a href="{{ route('bc_pe',$info->id) }}">{{ $info->judul }}</a></td>
                                  <td>{{ $info->kepada }}</td>
                                  <td>
                                  ...
                                  <td><a href="{{ route('ed.pe_admin',$info->id) }}" class="btn btn-icon icon-left btn-primary"> Edit</a></td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('hp_pe_admin') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
    ...
    <div class="modal fade" id="status{{ $info->id }}" tabdata-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('ed.st_pe_admin',$info->id) }}" method="get" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="id" value="{{ $info->id }}"/>
                    <div class="form-group">
